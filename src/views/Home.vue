<template>
  <div class="home">
    ...
    <div class="example-title"># 播放 ChimeePlayer</div>
    <chimee></chimee>
  </div>
</template>
...
import chimee from "@/components/chimee.vue";
  ...
  data() {
    return {
      ...
      videoInfo: [
        ...
        {
          title: "香港财经",
          videoSrc: "rtmp://202.69.69.180:443/webcast/bshdlive-pc"
        },
        {
          title: "湖南卫视",
        ...
        {
          title: "美国中文电视",
          videoSrc: "	rtsp://184.72.239.149/vod/mp4://BigBuckBunny_175k.mov"
        }
      ],
      imgSrc: "", // 图片路径
      canvas: "",
